...
const bcrypt = require("bcryptjs"); //used to create and hashes .
const jwt = require("jsonwebtoken");//used to pass identity of authenticated users.And relies on json standards.
